...
$art3 = "SELECT Department,count(*) as numa2 FROM student s inner join arts ar WHERE s.ID=ar.ID  group by Department";
 ...
 $queryintern="SELECT Job_Role,count(*) as numberintern from internship group by Job_Role";
...
<body>
  ...
  function redirectintern(){
    window.location.href="auth_intern_view/crud/index.php?ID=<?php echo urlencode($id)?>";
  ...
  function redirectpp(){
    window.location.href="auth_paper_view/crud/index.php?ID=<?php echo urlencode($id)?>";
...
<!-- // for project competition--> <script type="text/javascript">
    ...
    function drawChartpc()
    {
      ...
      var selectedItem = charta.getSelection()[0];
          if (selectedItem) {
            var topping = dataa.getValue(selectedItem.row, 0);
              window.location.href="auth_project_comp_view/crud/index.php?flag_graph=2&ID=<?php echo urlencode($id)?>&act="+topping;
          }
        }
    ...
    function drawCharta2()
    {
      ...
      var charta2 = new google.visualization.PieChart(document.getElementById('piechartpc1'));
       function selectHandler() {
          ...
          if (selectedItem) {
            var topping = dataa2.getValue(selectedItem.row, 0);
             window.location.href="auth_project_comp_view/crud/index.php?flag_graph=1&ID=<?php echo urlencode($id)?>&Dept="+topping;
          }
        }
 ...
 <script type="text/javascript">
    ...
    var charta1 = new google.visualization.ColumnChart(document.getElementById('chart_divpc'));
     function selectHandler() {
          ...
          if (selectedItem) {
            var topping = dataa1.getValue(selectedItem.row, 0);
             window.location.href="auth_project_comp_view/crud/project_yearbar.php?ID=<?php echo urlencode($id)?>&Year="+topping;
          }
        }
...
<!-- // for paper presentation--> <script type="text/javascript">
    ...
    function drawChartpp()
    {
      ...
      var selectedItem = charta.getSelection()[0];
          if (selectedItem) {
            var topping = dataa.getValue(selectedItem.row, 0);
              window.location.href="auth_paper_view/crud/index.php?flag_graph=2&ID=<?php echo urlencode($id)?>&act="+topping;
          }
        }
    ...
    function drawCharta2()
    {
      ...
      var charta2 = new google.visualization.PieChart(document.getElementById('piechartpp1'));
       function selectHandler() {
          ...
          if (selectedItem) {
            var topping = dataa2.getValue(selectedItem.row, 0);
             window.location.href="auth_paper_view/crud/index.php?flag_graph=1&ID=<?php echo urlencode($id)?>&Dept="+topping;
          }
        }
 ...
 <script type="text/javascript">
    ...
    var charta1 = new google.visualization.ColumnChart(document.getElementById('chart_divpp'));
     function selectHandler() {
          ...
          if (selectedItem) {
            var topping = dataa1.getValue(selectedItem.row, 0);
             window.location.href="auth_paper_view/crud/arts_yearbar.php?ID=<?php echo urlencode($id)?>&Year="+topping;
          }
        }
    ...
    function drawChartart()
    {
      var dataa=google.visualization.arrayToDataTable([
            ...
            <?php 
                ...
                {
                  echo "['".$row["Job_Role"]."',".$row["numberintern"]."],";
                }
      ...
      var selectedItem = charta.getSelection()[0];
          if (selectedItem) {
            var topping = dataa.getValue(selectedItem.row, 0);
              window.location.href="auth_intern_view/crud/index.php?flag_graph=2&ID=<?php echo urlencode($id)?>&act="+topping;
          }
        }
    ...
    function drawCharta2()
    {
      ...
      var charta2 = new google.visualization.PieChart(document.getElementById('piecharti1'));
       function selectHandler() {
          ...
          if (selectedItem) {
            var topping = dataa2.getValue(selectedItem.row, 0);
             window.location.href="auth_intern_view/crud/index.php?flag_graph=1&ID=<?php echo urlencode($id)?>&Dept="+topping;
          }
        }
 ...
 <script type="text/javascript">
    ...
    var charta1 = new google.visualization.ColumnChart(document.getElementById('chart_divi'));
     function selectHandler() {
          ...
          if (selectedItem) {
            var topping = dataa1.getValue(selectedItem.row, 0);
             window.location.href="auth_intern_view/crud/internship_yearbar.php?ID=<?php echo urlencode($id)?>&Year="+topping;
          }
        }

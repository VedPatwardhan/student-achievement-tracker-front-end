    ...
    <nav class="navbar navbar-expand-custom navbar-light darker">
      ...
      <?php } ?>
        ...
        <div class="collapse navbar-collapse" id="navbarTogglerDemo03">
          ...
          <li class="nav-item gap2">
            <form class="form" action="sports_dept.php" method="post" enctype="multipart/form-data" >
          ...
          <li class="nav-item gap2">
          <form class="form" action="sports_search.php" method="post" enctype="multipart/form-data" >

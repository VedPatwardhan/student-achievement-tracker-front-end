    ...
    <nav class="navbar navbar-expand-custom navbar-light darker">
      ...
      <?php } ?>
        ...
        <div class="collapse navbar-collapse" id="navbarTogglerDemo03">
          ...
          <li class="nav-item gap2">
            <form class="form" action="sports_dept.php?sql_search=<?php echo urlencode($sql_search)?>" method="post" enctype="multipart/form-data" >
          ...
          <li class="nav-item gap2">
          <form class="form" action="sports_search.php?sql_dept=<?php echo urlencode($sql_dept)?>" method="post" enctype="multipart/form-data" >
          <input list="search" name="search" id="srch" onchange="myFunction(this)" class="input-field center" autocomplete="off" placeholder="Search By">
            ...
            <div id="Spt" style="display: none;">
              <input name="sports_n" type="text" placeholder="Enter Sports Name" class="input-field">
              <button type="submit" class="form-button" ></span><i class="fa fa-search"></i>
              </button>
            </div>
            ...
            <div id="Achiv" style="display: none;">
              <input name="achievements" type="text" placeholder="Enter Achievements" class="input-field">
              <button type="submit" class="form-button" ></span><i class="fa fa-search"></i>
              </button>
            </div> 
      ...
      <table class="table table-bordered">
       <thead>
        <tr style="font-size: 14.3px;">
          ...
          <th>
            <form action="session_m.php" method="post">
            <input type="hidden" name="column" value="Sports_Name">
            <input type="hidden" name="order" value="<?php echo $asc_or_desc?>">
            <input type="hidden" name="flag" value="<?php echo $flag ?>">
            <a href="session_m.php" onclick="this.closest('form').submit();return false;">Sports Name<i class="fas fa-sort<?php echo $column == 'Sports_Name' ? '-' . $up_or_down : ''; ?>"></i></a>
          </form>
        </th>
          <th>
            <form action="session_m.php" method="post">
          ...
          <th>
            <form action="session_m.php" method="post">
            <input type="hidden" name="column" value="Achievements">
            <input type="hidden" name="order" value="<?php echo $asc_or_desc?>">
            <input type="hidden" name="flag" value="<?php echo $flag ?>">
            <a href="session_m.php" onclick="this.closest('form').submit();return false;">Achievements<i class="fas fa-sort<?php echo $column == 'Achievements' ? '-' . $up_or_down : ''; ?>"></i></a>
            </form> 
          </th>
          <th>
            <form action="session_m.php" method="post">
            <input type="hidden" name="column" value="Date_Sports">
            <input type="hidden" name="order" value="<?php echo $asc_or_desc?>">
            <input type="hidden" name="flag" value="<?php echo $flag ?>">
            <a href="session_m.php" onclick="this.closest('form').submit();return false;">Date of Occasion<i class="fas fa-sort<?php echo $column == 'Date_Sports' ? '-' . $up_or_down : ''; ?>"></i></a>
            </form>
          </th>
          <th>Certificate</th>
        </tr>

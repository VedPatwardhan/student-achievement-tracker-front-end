...
if (isset ($_POST['Type'])  && isset($_POST['Domain']) && isset($_POST['Guide']) && isset($_POST['publish'])  && isset($_POST['DOB']) ) {
    ...
    $sql = 'INSERT INTO paper_presentation(UID,ID,Title,Domain,Guide,Organisation_publish,Date_publish) VALUES(:uid,:id,:type,:dom,:guide,:pub,:dob)';
    $statement = $connection->prepare($sql);
    if ($statement->execute([':uid' => $uid,':id' => $id,':type' => $type,':dom' => $dom,':guide' => $guide,':pub' => $pub,':dob' => $dob])) {

...
if (isset ($_POST['name'])  && isset($_POST['purpose']) && isset($_POST['no'])   && isset($_POST['DO']) && isset($_POST['coordinator'])   ) {
  ...
  $dob = date('Y-m-d',strtotime($rawdate));
   ...
   $sql = 'UPDATE formr SET Name=:name,Purpose=:purpose,Students=:no,Date_visit=:dob,Coordinator=:coordinator WHERE UID=:uid';
  $statement = $connection->prepare($sql);
      ...
      <form method="post">
        ...
        <div class="form-group">
         ...
         <div class="form-group">
          ...
          <input value="<?= $person->Date_visit; ?>" type="text" name="DO" id="DO" class="form-control">
        </div>

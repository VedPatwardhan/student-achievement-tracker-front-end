...
$print = isset($_SESSION['print']) ? $_SESSION ['print'] : 'FormB:- All Teachers';
$sql_search = '';
$sql_dept = '';
$_SESSION['flag'] = $flag;
  if($flag == 1){
        ...
        <div class="collapse navbar-collapse" id="navbarTogglerDemo03">
          ...
          <!--  -->
              <datalist id="search">
                ...
                <option  value="Speaker">Speaker/Resource Person</option>
            ...
            <div id="speak" style="display: none;">
              <input name="Speaker" type="text" placeholder="Enter Speaker name" class="input-field">
              <button type="submit" class="form-button" ></span><i class="fa fa-search"></i>
              </button>
            </div> 
       ...
       <thead>
        ...
        <?php if($_SESSION['login_flag'] == 2 && isset($_SESSION['CH'])){  ?>
          ...
          <th>
            ...
            <input type="hidden" name="order" value="<?php echo $asc_or_desc?>">
            <input type="hidden" name="flag" value="<?php echo $flag ?>">
            <a href="session_m.php" onclick="this.closest('form').submit();return false;">Activity/ Event<i class="fas fa-sort<?php echo $column == 'Activity' ? '-' . $up_or_down : ''; ?>"></i></a>
          </form>
          </th>
          <th>
            <form action="session_m.php" method="post">
          ...
          <th>
            <form action="session_m.php" method="post">
            <input type="hidden" name="column" value="Speaker">
            <input type="hidden" name="order" value="<?php echo $asc_or_desc?>">
            <input type="hidden" name="flag" value="<?php echo $flag ?>">
            <a href="session_m.php" onclick="this.closest('form').submit();return false;">Speaker/ Resource Person<i class="fas fa-sort<?php echo $column == 'Speaker' ? '-' . $up_or_down : ''; ?>"></i></a>
          </form>
        </th>
          ...
          <th>
            ...
            <input type="hidden" name="order" value="<?php echo $asc_or_desc?>">
            <input type="hidden" name="flag" value="<?php echo $flag ?>">
            <a href="session_m.php" onclick="this.closest('form').submit();return false;">No. of Participants<i class="fas fa-sort<?php echo $column == 'Participants' ? '-' . $up_or_down : ''; ?>"></i></a>
            </form>
          </th>

...
$print = isset($_SESSION['print']) ? $_SESSION ['print'] : 'FormM:- All Teachers';
$sql_search = '';
$sql_dept = '';
$_SESSION['flag'] = $flag;
  if($flag == 1){
        ...
        <div class="collapse navbar-collapse" id="navbarTogglerDemo03">
          ...
          <!--  -->
              <datalist id="search">
                ...
                <option  value="Name">Name of the Investigator(s) </option>
                <option  value="Faculty">Faculty (Stream) </option>
                 <option  value="Title">Title of the Research Project/Scheme  </option>
                <option  value="Sanction">Sanctioned order no.& Date </option>
                <option  value="Fund">Name of the Funding Agency  </option>
                <option  value="Amount">Amount Sanctioned(Rs.)  </option>
                <option  value="Major">Major/Minor  </option>
            ...
            <div class="input-group" id="nm" style="display: none;">
              <input name="Name" type="text" placeholder="Enter Name of Investigator" class="input-field">
                <button  type="submit" class="form-button"></span><i class="fa fa-search"></i>
                </button>
            </div> 
            <div id="fac" style="display: none;">
              <input name="Faculty" type="text" placeholder="Enter Faculty(Stream)" class="input-field">
              <button type="submit" class="form-button" ></span><i class="fa fa-search"></i>
              </button>
            </div> 
            ...
            <div id="sanc" style="display: none;">
              <input name="Sanction" type="text" placeholder="Enter Sanction details" class="input-field">
              <button type="submit" class="form-button" ></span><i class="fa fa-search"></i>
              </button>
            </div> 
            <div id="fund" style="display: none;">
              <input name="Fund" type="text" placeholder="Enter fund Details" class="input-field"><br>
              <button type="submit" class="form-button" ></span><i class="fa fa-search"></i>
              </button>
            </div> 
            ...
            <div id="major" style="display: none;">
              <input name="Major" type="text" placeholder="Enter Major/ Minor" class="input-field"><br>
              <button type="submit" class="form-button" ></span><i class="fa fa-search"></i>
              </button>
            </div> 
            <li class="nav-item" >
...
<script type="text/javascript">
  ...
  function myFunction(option){
          ...
          if(opt == "Sanction"){
            document.getElementById("sanc").style.display = "block";
            document.getElementById("srch").style.display = "none";
          }
          if(opt == "Fund"){
       ...
       <thead>
        ...
        <?php if($_SESSION['login_flag'] == 2 && isset($_SESSION['CH'])){  ?>
          ...
          <th>
            ...
            <input type="hidden" name="order" value="<?php echo $asc_or_desc?>">
            <input type="hidden" name="flag" value="<?php echo $flag ?>">
            <a href="session_m.php" onclick="this.closest('form').submit();return false;">Name of the Investigator(s) <i class="fas fa-sort<?php echo $column == 'Name' ? '-' . $up_or_down : ''; ?>"></i></a>
          </form>
          </th>
          <th>
            <form action="session_m.php" method="post">
            ...
            <input type="hidden" name="order" value="<?php echo $asc_or_desc?>">
            <input type="hidden" name="flag" value="<?php echo $flag ?>">
            <a href="session_m.php" onclick="this.closest('form').submit();return false;">Faculty (Stream)  <i class="fas fa-sort<?php echo $column == 'Faculty' ? '-' . $up_or_down : ''; ?>"></i></a>
          </form>
        </th>
          <th>
            <form action="session_m.php" method="post">
            ...
            <input type="hidden" name="order" value="<?php echo $asc_or_desc?>">
            <input type="hidden" name="flag" value="<?php echo $flag ?>">
            <a href="session_m.php" onclick="this.closest('form').submit();return false;">Title of the Research Project/Scheme  <i class="fas fa-sort<?php echo $column == 'Title' ? '-' . $up_or_down : ''; ?>"></i></a>
          </form>
          </th>
          
          <th>
            <form action="session_m.php" method="post">
            <input type="hidden" name="column" value="Sanction">
            <input type="hidden" name="order" value="<?php echo $asc_or_desc?>">
            <input type="hidden" name="flag" value="<?php echo $flag ?>">
            <a href="session_m.php" onclick="this.closest('form').submit();return false;">Sanctioned order no.& Date  <i class="fas fa-sort<?php echo $column == 'Sanction' ? '-' . $up_or_down : ''; ?>"></i></a>
            </form>
          </th>
          <th>
            <form action="session_m.php" method="post">
            <input type="hidden" name="column" value="Fund">
            <input type="hidden" name="order" value="<?php echo $asc_or_desc?>">
            <input type="hidden" name="flag" value="<?php echo $flag ?>">
            <a href="session_m.php" onclick="this.closest('form').submit();return false;">Name of the Funding Agency  <i class="fas fa-sort<?php echo $column == 'Fund' ? '-' . $up_or_down : ''; ?>"></i></a>
            </form>
          </th>
          <th>
            <form action="session_m.php" method="post">
            ...
            <input type="hidden" name="order" value="<?php echo $asc_or_desc?>">
            <input type="hidden" name="flag" value="<?php echo $flag ?>">
            <a href="session_m.php" onclick="this.closest('form').submit();return false;">Amount Sanctioned(Rs.)  <i class="fas fa-sort<?php echo $column == 'Amount' ? '-' . $up_or_down : ''; ?>"></i></a>
            </form> 
          </th>
          <th>
            <form action="session_m.php" method="post">
            <input type="hidden" name="column" value="Major">
            <input type="hidden" name="order" value="<?php echo $asc_or_desc?>">
            <input type="hidden" name="flag" value="<?php echo $flag ?>">
            <a href="session_m.php" onclick="this.closest('form').submit();return false;">Major/ Minor<i class="fas fa-sort<?php echo $column == 'Major' ? '-' . $up_or_down : ''; ?>"></i></a>
            </form> 
          </th>
          <th>
            <form action="session_m.php" method="post">
          ...
          <th>
            ...
            <input type="hidden" name="order" value="<?php echo $asc_or_desc?>">
            <input type="hidden" name="flag" value="<?php echo $flag ?>">
            <a href="session_m.php" onclick="this.closest('form').submit();return false;">End Date<i class="fas fa-sort<?php echo $column == 'Date_end' ? '-' . $up_or_down : ''; ?>"></i></a>
            </form>
          </th>
          <th>Certificate</th>
        </tr>

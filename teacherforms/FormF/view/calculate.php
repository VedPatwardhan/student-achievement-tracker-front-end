        ...
        <div class="collapse navbar-collapse" id="navbarTogglerDemo03">
          ...
          <input list="search" name="search" id="srch" onchange="myFunction(this)" class="input-field center" autocomplete="off" placeholder="Search By">
              ...
              <datalist id="search">
                ...
                <option  value="Name">  Name of sponsoring Industry/Company</option>
                <option  value="Sponsor">Name of sponsored Lab</option>
                <option  value="Support">Type of support</option>
                <option  value="Grant_money">Grant in Rs. (if any)</option>
                <option  value="Year">Year of establishment</option>
            ...
            <div id="sponsor" style="display: none;">
              <input name="Sponsor" type="text" placeholder="Enter Sponsor" class="input-field">
              <button type="submit" class="form-button" ></span><i class="fa fa-search"></i>
              </button>
            </div>
            <div id="support" style="display: none;">
              <input name="Support" type="text" placeholder="Enter Type of Support" class="input-field">
              <button type="submit" class="form-button" ></span><i class="fa fa-search"></i>
              </button>
            </div> 
            <div id="grant" style="display: none;">
              <input name="Grant_money" type="text" placeholder="Enter Grant amount" class="input-field">
              <button type="submit" class="form-button" ></span><i class="fa fa-search"></i>
              </button>
            </div> 
            <div id="yr" style="display: none;">
              <input name="Year" type="text" placeholder="Enter Participants" class="input-field"><br>
              <button type="submit" class="form-button" ></span><i class="fa fa-search"></i>
              </button>
            </div> 
            <li class="nav-item" >
       ...
       <thead>
        ...
        <?php if($_SESSION['login_flag'] == 2 && isset($_SESSION['CH'])){  ?>
          ...
          <th>
            ...
            <input type="hidden" name="order" value="<?php echo $asc_or_desc?>">
            <input type="hidden" name="flag" value="<?php echo $flag ?>">
            <a href="session_m.php" onclick="this.closest('form').submit();return false;">Name of sponsoring Industry/Company<i class="fas fa-sort<?php echo $column == 'Name' ? '-' . $up_or_down : ''; ?>"></i></a>
          </form>
          </th>
          <th>
            <form action="session_m.php" method="post">
            ...
            <input type="hidden" name="order" value="<?php echo $asc_or_desc?>">
            <input type="hidden" name="flag" value="<?php echo $flag ?>">
            <a href="session_m.php" onclick="this.closest('form').submit();return false;">Name of sponsored Lab<i class="fas fa-sort<?php echo $column == 'Sponsor' ? '-' . $up_or_down : ''; ?>"></i></a>
          </form>
          </th>
          <th>
            <form action="session_m.php" method="post">
            <input type="hidden" name="column" value="Support">
            <input type="hidden" name="order" value="<?php echo $asc_or_desc?>">
            <input type="hidden" name="flag" value="<?php echo $flag ?>">
            <a href="session_m.php" onclick="this.closest('form').submit();return false;">Type of support <i class="fas fa-sort<?php echo $column == 'Support' ? '-' . $up_or_down : ''; ?>"></i></a>
          </form>
        </th>
          <th>
            <form action="session_m.php" method="post">
            <input type="hidden" name="column" value="Grant_money">
            <input type="hidden" name="order" value="<?php echo $asc_or_desc?>">
            <input type="hidden" name="flag" value="<?php echo $flag ?>">
            <a href="session_m.php" onclick="this.closest('form').submit();return false;">Grant in Rs. (if any) <i class="fas fa-sort<?php echo $column == 'Grant_money' ? '-' . $up_or_down : ''; ?>"></i></a>
            </form>
          </th>
          <th>
            <form action="session_m.php" method="post">
            ...
            <input type="hidden" name="order" value="<?php echo $asc_or_desc?>">
            <input type="hidden" name="flag" value="<?php echo $flag ?>">
            <a href="session_m.php" onclick="this.closest('form').submit();return false;">Year of establishment <i class="fas fa-sort<?php echo $column == 'Year' ? '-' . $up_or_down : ''; ?>"></i></a>
            </form>
          </th>

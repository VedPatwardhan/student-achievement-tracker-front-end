...
$print = isset($_SESSION['print']) ? $_SESSION ['print'] : 'FormO:- All Teachers';
$sql_search = '';
$sql_dept = '';
$_SESSION['flag'] = $flag;
  if($flag == 1){
      ...
      <?php } ?>
        ...
        <div class="collapse navbar-collapse" id="navbarTogglerDemo03">
          ...
          <!--  -->
            ...
            <div class="input-group" id="cls" style="display: none;">
              <input name="Class" type="text" placeholder="Enter Name" class="input-field">
                <button  type="submit" class="form-button"></span><i class="fa fa-search"></i>
                </button>
            </div> 
            <div id="ach" style="display: none;">
              <input name="Achievement" type="text" placeholder="Enter Achievement" class="input-field">
              <button type="submit" class="form-button" ></span><i class="fa fa-search"></i>
              </button>
            </div>
            
            <div id="rmk" style="display: none;">
              <input name="Remark" type="text" placeholder="Enter Remarks" class="input-field"><br>
              <button type="submit" class="form-button" ></span><i class="fa fa-search"></i>
              </button>
            </div> 
            <li class="nav-item" >
       ...
       <thead>
        ...
        <?php if($_SESSION['login_flag'] == 2 && isset($_SESSION['CH'])){  ?>
          ...
          <th>
            ...
            <input type="hidden" name="order" value="<?php echo $asc_or_desc?>">
            <input type="hidden" name="flag" value="<?php echo $flag ?>">
            <a href="session_m.php" onclick="this.closest('form').submit();return false;">Name of Student<i class="fas fa-sort<?php echo $column == 'Name' ? '-' . $up_or_down : ''; ?>"></i></a>
          </form>
          </th>
          <th>
            <form action="session_m.php" method="post">
          ...
          <th>
            ...
            <input type="hidden" name="order" value="<?php echo $asc_or_desc?>">
            <input type="hidden" name="flag" value="<?php echo $flag ?>">
            <a href="session_m.php" onclick="this.closest('form').submit();return false;">Achievement<i class="fas fa-sort<?php echo $column == 'Achievement' ? '-' . $up_or_down : ''; ?>"></i></a>
          </form>
          </th>

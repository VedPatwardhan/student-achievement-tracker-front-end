...
$uid ='';
        ...
        $sql = "SELECT * FROM formP WHERE ID = '$id'";
...
<html lang="en">
  <head>
    <title>P. Departmental Achievement</title>
    <!-- Required meta tags -->
    <meta charset="utf-8">
       ...
       ?>
        <tr>
            ...
            <td >  
              <div>                        
                <form action="../../file/filesLogic.php?uid=<?php echo $uid?>&type=formP&flag_file=2" method="post" enctype="multipart/form-data" >
                 <a href="../../file/solo_download.php?uid=<?php echo $uid?>&type=formP&flag_file=2" style="margin:5%;" class="btn btn-info">Download latest copy</a>

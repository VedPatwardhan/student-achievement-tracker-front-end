...
$uid ='';
        ...
        $sql = "SELECT * FROM formD WHERE ID = '$id'";
        $result = mysqli_query ($conn,$sql) or die ('Error');
 ?>

<html lang="en">
  <head>
    <title>D.  Collaboration / MoU with National / International Institute/Industry /Research Center/Colleges/University.</title>
    <!-- Required meta tags -->
    <meta charset="utf-8">
        ...
        <tr>
           ...
           <!-- <a href="edit.php?uid=<?php echo urlencode($uid) ?>" style="margin:5%;" class="btn btn-info">Edit</a>-->
            ...
            <td>  
              <div>                        
                <form action="../../file/filesLogic.php?uid=<?php echo $uid?>&type=formD&flag_file=2" method="post" enctype="multipart/form-data" >
                 <a href="../../file/solo_download.php?uid=<?php echo $uid?>&type=formD&flag_file=2" style="margin:5%;" class="btn btn-info">Download latest copy</a>

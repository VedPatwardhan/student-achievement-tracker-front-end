        ...
        <div class="collapse navbar-collapse" id="navbarTogglerDemo03">
          ...
          <input list="search" name="search" id="srch" onchange="myFunction(this)" class="input-field center" autocomplete="off" placeholder="Search By">
              <datalist id="search">
                ...
                <option  value="Name">Name of Institute</option>
                <option  value="Collaboration">Collaboration/MoU</option>
            ...
            <div class="input-group" id="name1" style="display: none;">
              <input name="name" type="text" placeholder="Enter Name" class="input-field">
                <button  type="submit" class="form-button"></span><i class="fa fa-search"></i>
                </button>
            </div> 
            <div id="collab1" style="display: none;">
              <input name="collab" type="text" placeholder="Enter Collaboration Title" class="input-field">
              <button type="submit" class="form-button" ></span><i class="fa fa-search"></i>
              </button>
            </div>
...
<script type="text/javascript">
  function myFunction(option){
          ...
          if(opt == "Collaboration"){
            document.getElementById("collab1").style.display = "block"; 
            document.getElementById("srch").style.display = "none";       
          }
       ...
       <thead>
        ...
        <?php if($_SESSION['login_flag'] == 2 && isset($_SESSION['CH'])){  ?>
          ...
          <th>
            ...
            <input type="hidden" name="order" value="<?php echo $asc_or_desc?>">
            <input type="hidden" name="flag" value="<?php echo $flag ?>">
            <a href="session_m.php" onclick="this.closest('form').submit();return false;">Name of Institution<i class="fas fa-sort<?php echo $column == 'Name' ? '-' . $up_or_down : ''; ?>"></i></a>
          </form>
          </th>
          <th>
            <form action="session_m.php" method="post">
            <input type="hidden" name="column" value="Collab">
            <input type="hidden" name="order" value="<?php echo $asc_or_desc?>">
            <input type="hidden" name="flag" value="<?php echo $flag ?>">
            <a href="session_m.php" onclick="this.closest('form').submit();return false;">Collaboration /MoU<i class="fas fa-sort<?php echo $column == 'Collab' ? '-' . $up_or_down : ''; ?>"></i></a>
          </form>
          </th>
          ...
          <th>
            ...
            <input type="hidden" name="order" value="<?php echo $asc_or_desc?>">
            <input type="hidden" name="flag" value="<?php echo $flag ?>">
            <a href="session_m.php" onclick="this.closest('form').submit();return false;">Remarks<i class="fas fa-sort<?php echo $column == 'Remark' ? '-' . $up_or_down : ''; ?>"></i></a>
            </form> 
          </th>
          <th>
            <form action="session_m.php" method="post">

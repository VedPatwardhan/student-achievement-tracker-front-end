...
$print = isset($_SESSION['print']) ? $_SESSION ['print'] : 'FormH:- All Teachers';
$sql_search = '';
$sql_dept = '';
$_SESSION['flag'] = $flag;
  if($flag == 1){
        ...
        <div class="collapse navbar-collapse" id="navbarTogglerDemo03">
          ...
          <input list="search" name="search" id="srch" onchange="myFunction(this)" class="input-field center" autocomplete="off" placeholder="Search By">
            ...
            <div id="Year" style="display: none;">
              <input name="Year" type="text" placeholder="Enter Year" class="input-field">
              <button type="submit" class="form-button" ></span><i class="fa fa-search"></i>
              </button>
            </div>
            <div id="Crs" style="display: none;">
              <input name="Course" type="text" placeholder="Enter Course name" class="input-field">
              <button type="submit" class="form-button" ></span><i class="fa fa-search"></i>
              </button>
            </div> 
            <div id="Fin" style="display: none;">
              <input name="Finance" type="text" placeholder="Enter Finance" class="input-field">
              <button type="submit" class="form-button" ></span><i class="fa fa-search"></i>
              </button>
            </div> 
            <div id="cnt" style="display: none;">
              <input name="Count1" type="text" placeholder="Enter Count" class="input-field"><br>
              <button type="submit" class="form-button" ></span><i class="fa fa-search"></i>
              </button>
            </div> 
            <li class="nav-item" >
      ...
      <table class="table table-bordered">
       <thead>
        ...
        <?php if($_SESSION['login_flag'] == 2 && isset($_SESSION['CH'])){  ?>
          ...
          <th>
            <form action="session_m.php" method="post">
            <input type="hidden" name="column" value="Course">
            <input type="hidden" name="order" value="<?php echo $asc_or_desc?>">
            <input type="hidden" name="flag" value="<?php echo $flag ?>">
            <a href="session_m.php" onclick="this.closest('form').submit();return false;">Course<i class="fas fa-sort<?php echo $column == 'Course' ? '-' . $up_or_down : ''; ?>"></i></a>
          </form>
        </th>
        <th>
            <form action="session_m.php" method="post">
          ...
          <th>
            <form action="session_m.php" method="post">
            <input type="hidden" name="column" value="Finance">
            <input type="hidden" name="order" value="<?php echo $asc_or_desc?>">
            <input type="hidden" name="flag" value="<?php echo $flag ?>">
            <a href="session_m.php" onclick="this.closest('form').submit();return false;">Finance<i class="fas fa-sort<?php echo $column == 'Finance' ? '-' . $up_or_down : ''; ?>"></i></a>
            </form>
          </th>
          <th>
            <form action="session_m.php" method="post">
            <input type="hidden" name="column" value="Count1">
            <input type="hidden" name="order" value="<?php echo $asc_or_desc?>">
            <input type="hidden" name="flag" value="<?php echo $flag ?>">
            <a href="session_m.php" onclick="this.closest('form').submit();return false;">Count1<i class="fas fa-sort<?php echo $column == 'Count1' ? '-' . $up_or_down : ''; ?>"></i></a>
            </form>
          </th>
         <th>
            <form action="session_m.php" method="post">

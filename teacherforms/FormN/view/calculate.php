...
$print = isset($_SESSION['print']) ? $_SESSION ['print'] : 'FormN:- All Teachers';
$sql_search = '';
$sql_dept = '';
$_SESSION['flag'] = $flag;
  if($flag == 1){
        ...
        <div class="collapse navbar-collapse" id="navbarTogglerDemo03">
          ...
          <!--  -->
              <datalist id="search">
                ...
                <option  value="Name">Name of Staff </option>
       ...
       <thead>
        ...
        <?php if($_SESSION['login_flag'] == 2 && isset($_SESSION['CH'])){  ?>
          ...
          <th>
            ...
            <input type="hidden" name="order" value="<?php echo $asc_or_desc?>">
            <input type="hidden" name="flag" value="<?php echo $flag ?>">
            <a href="session_m.php" onclick="this.closest('form').submit();return false;">Name of Staff<i class="fas fa-sort<?php echo $column == 'Name' ? '-' . $up_or_down : ''; ?>"></i></a>
          </form>
          </th>
          <th>
            <form action="session_m.php" method="post">

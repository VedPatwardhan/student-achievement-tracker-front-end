...
if (isset ($_POST['name'])  && isset($_POST['achievement']) &&  isset($_POST['remark']) ) {
  ...
  $uid = uniqid("FN-");
  $sql = 'INSERT INTO formn(UID,ID,Name,Achievement,Remark,Date_start) VALUES(:uid,:id,:name,:achievement,:remark,:ds)';
  $statement = $connection->prepare($sql);
  if ($statement->execute([':uid' => $uid,':id' => $id,':name' => $name,':achievement' => $achievement,':remark'=>$remark,':ds'=>$currdate])) {
...
<div class="container">
  <div class="card mt-5">
    ...
    <div class="card-body">
      ...
      <?php endif; ?>
      <!-- <form method="post" action="/projects/teacherforms/formN/file_entry.php"> -->

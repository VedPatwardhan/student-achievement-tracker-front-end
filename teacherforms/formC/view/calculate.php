        ...
        <div class="collapse navbar-collapse" id="navbarTogglerDemo03">
          ...
          <!--  -->
              <datalist id="search">
                ...
                <option  value="Type">Type/ Nature</option>
                <option  value="Organiser">Organiser</option>
                <option  value="Staff">Name of Staff</option>
                <option  value="Sponsorship">Sponsorship Details</option>
            ...
            <div id="org" style="display: none;">
              <input name="Organiser" type="text" placeholder="Enter Organiser" class="input-field">
              <button type="submit" class="form-button" ></span><i class="fa fa-search"></i>
              </button>
            </div> 
            <div id="staff" style="display: none;">
              <input name="Staff" type="text" placeholder="Enter Staff name" class="input-field"><br>
              <button type="submit" class="form-button" ></span><i class="fa fa-search"></i>
              </button>
            </div> 
            <div id="sponser" style="display: none;">
              <input name="Sponsorship" type="text" placeholder="Enter Sponsorship Details" class="input-field"><br>
              <button type="submit" class="form-button" ></span><i class="fa fa-search"></i>
              </button>
            </div>
       ...
       <thead>
        ...
        <?php if($_SESSION['login_flag'] == 2 && isset($_SESSION['CH'])){  ?>
          ...
          <th>
            ...
            <input type="hidden" name="order" value="<?php echo $asc_or_desc?>">
            <input type="hidden" name="flag" value="<?php echo $flag ?>">
            <a href="session_m.php" onclick="this.closest('form').submit();return false;">Type/ Nature<i class="fas fa-sort<?php echo $column == 'Type' ? '-' . $up_or_down : ''; ?>"></i></a>
          </form>
        </th>
          <th>
            <form action="session_m.php" method="post">
            <input type="hidden" name="column" value="Organiser">
            <input type="hidden" name="order" value="<?php echo $asc_or_desc?>">
            <input type="hidden" name="flag" value="<?php echo $flag ?>">
            <a href="session_m.php" onclick="this.closest('form').submit();return false;">Name of organizer<i class="fas fa-sort<?php echo $column == 'Organiser' ? '-' . $up_or_down : ''; ?>"></i></a>
            </form>
          </th>
          <th>
            <form action="session_m.php" method="post">
            <input type="hidden" name="column" value="Staff">
            <input type="hidden" name="order" value="<?php echo $asc_or_desc?>">
            <input type="hidden" name="flag" value="<?php echo $flag ?>">
            <a href="session_m.php" onclick="this.closest('form').submit();return false;">Name of Staff<i class="fas fa-sort<?php echo $column == 'Staff' ? '-' . $up_or_down : ''; ?>"></i></a>
            </form>
          </th>
          <th>
            <form action="session_m.php" method="post">
            <input type="hidden" name="column" value="Sponsorship">
            <input type="hidden" name="order" value="<?php echo $asc_or_desc?>">
            <input type="hidden" name="flag" value="<?php echo $flag ?>">
            <a href="session_m.php" onclick="this.closest('form').submit();return false;">Sponsorship Details<i class="fas fa-sort<?php echo $column == 'Sponsorship' ? '-' . $up_or_down : ''; ?>"></i></a>
            </form> 
          </th>

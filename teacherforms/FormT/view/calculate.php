...
$print = isset($_SESSION['print']) ? $_SESSION ['print'] : 'FormT:- All Teachers';
$sql_search = '';
$sql_dept = '';
$_SESSION['flag'] = $flag;
  if($flag == 1){
...
<html lang="en">
  <head>
    <title>Form T Information</title>
  <meta charset="utf-8">
        ...
        <div class="collapse navbar-collapse" id="navbarTogglerDemo03">
          ...
          <input list="search" name="search" id="srch" onchange="myFunction(this)" class="input-field center" autocomplete="off" placeholder="Search By">
            ...
            <div id="Organizer" style="display: none;">
              <input name="Organizer" type="text" placeholder="Enter Organizer" class="input-field">
              <button type="submit" class="form-button" ></span><i class="fa fa-search"></i>
              </button>
            </div>
            ...
            <div id="Remark" style="display: none;">
              <input name="Remark" type="text" placeholder="Enter Remark" class="input-field"><br>
              <button type="submit" class="form-button" ></span><i class="fa fa-search"></i>
              </button>
            </div>
      ...
      <table class="table table-bordered">
       <thead>
        ...
        <?php if($_SESSION['login_flag'] == 2 && isset($_SESSION['CH'])){  ?>
          ...
          <th>
            <form action="session_m.php" method="post">
            <input type="hidden" name="column" value="Organizer">
            <input type="hidden" name="order" value="<?php echo $asc_or_desc?>">
            <input type="hidden" name="flag" value="<?php echo $flag ?>">
            <a href="session_m.php" onclick="this.closest('form').submit();return false;">Organizer<i class="fas fa-sort<?php echo $column == 'Organizer' ? '-' . $up_or_down : ''; ?>"></i></a>
          </form>
          </th>
          <th>
            <form action="session_m.php" method="post">
          ...
          <th>
            <form action="session_m.php" method="post">
            <input type="hidden" name="column" value="Remark">
            <input type="hidden" name="order" value="<?php echo $asc_or_desc?>">
            <input type="hidden" name="flag" value="<?php echo $flag ?>">
            <a href="session_m.php" onclick="this.closest('form').submit();return false;">Remark<i class="fas fa-sort<?php echo $column == 'Remark' ? '-' . $up_or_down : ''; ?>"></i></a>
            </form> 
          </th>

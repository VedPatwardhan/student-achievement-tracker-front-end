...
$uid ='';
        ...
        $sql = "SELECT * FROM formG WHERE ID = '$id'";
        ...
        <tr>
         ...
         <td><?php echo $row ['OrderNo'];?>
            ...
            <td >  
              <div>                        
                <form action="../../file/filesLogic.php?uid=<?php echo $uid?>&type=formG&flag_file=2" method="post" enctype="multipart/form-data" >
                 <a href="../../file/solo_download.php?uid=<?php echo $uid?>&type=formG&flag_file=2" style="margin:5%;" class="btn btn-info">Download latest copy</a>

...
$uid ='';
        ...
        $sql = "SELECT * FROM formQ WHERE ID = '$id'";
...
<html lang="en">
  <head>
    <title>Q.  Technical Competitions / Tech Fest Organized / Participated
</title>
    <!-- Required meta tags -->
    <meta charset="utf-8">
       ...
       ?>
        <tr>
            ...
            <td >  
              <div>                        
                <form action="../../file/filesLogic.php?uid=<?php echo $uid?>&type=formQ&flag_file=2" method="post" enctype="multipart/form-data" >
                 <a href="../../file/solo_download.php?uid=<?php echo $uid?>&type=formQ&flag_file=2" style="margin:5%;" class="btn btn-info">Download latest copy</a>

...
$uid ='';
        ...
        $sql = "SELECT * FROM formJ WHERE ID = '$id'";
        ...
        <tr>
         ...
         <td><?php echo $row ['License'];?>
            ...
            <td >  
              <div>                        
                <form action="../../file/filesLogic.php?uid=<?php echo $uid?>&type=formJ&flag_file=2" method="post" enctype="multipart/form-data" >
                 <a href="../../file/solo_download.php?uid=<?php echo $uid?>&type=formJ&flag_file=2" style="margin:5%;" class="btn btn-info">Download latest copy</a>

...
$uid ='';
        ...
        $sql = "SELECT * FROM formT WHERE ID = '$id'";
...
<html lang="en">
  <head>
    <title>T.  Any other informTtion (As applicable )
 </title>
    <!-- Required meta tags -->
    <meta charset="utf-8">
        ...
        <tr>
         ...
         <td><?php echo $row ['Prize'];?>
            ...
            <td >  
              <div>                        
                <form action="../../file/filesLogic.php?uid=<?php echo $uid?>&type=formT&flag_file=2" method="post" enctype="multipart/form-data" >
                 <a href="../../file/solo_download.php?uid=<?php echo $uid?>&type=formT&flag_file=2" style="margin:5%;" class="btn btn-info">Download latest copy</a>

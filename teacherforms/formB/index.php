...
$uid ='';
        ...
        $sql = "SELECT * FROM formB WHERE ID = '$id'";
...
<html lang="en">
  <head>
    <title>B.	Webinar / video conference /Invited talks organized /conducted.</title>
    <!-- Required meta tags -->
    <meta charset="utf-8">
        ...
        <tr>
           ...
           <!-- <a href="edit.php?uid=<?php echo urlencode($uid) ?>" style="margin:5%;" class="btn btn-info">Edit</a>-->
            ...
            <td>  
              <div>                        
                <form action="../../file/filesLogic.php?uid=<?php echo $uid?>&type=formB&flag_file=2" method="post" enctype="multipart/form-data" >
                 <a href="../../file/solo_download.php?uid=<?php echo $uid?>&type=formB&flag_file=2" style="margin:5%;" class="btn btn-info">Download latest copy</a>

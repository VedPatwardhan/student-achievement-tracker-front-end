...
$print = isset($_SESSION['print']) ? $_SESSION ['print'] : 'FormR:- All Teachers';
$sql_search = '';
$sql_dept = '';
$_SESSION['flag'] = $flag;
  if($flag == 1){
...
<html lang="en">
  <head>
    <title>Form R Information</title>
  <meta charset="utf-8">
        ...
        <div class="collapse navbar-collapse" id="navbarTogglerDemo03">
          ...
          <input list="search" name="search" id="srch" onchange="myFunction(this)" class="input-field center" autocomplete="off" placeholder="Search By">
            ...
            <div id="Purpose" style="display: none;">
              <input name="Purpose" type="text" placeholder="Enter Purpose" class="input-field">
              <button type="submit" class="form-button" ></span><i class="fa fa-search"></i>
              </button>
            </div>
            <div id="Students" style="display: none;">
              <input name="Students" type="text" placeholder="Enter Students" class="input-field">
              <button type="submit" class="form-button" ></span><i class="fa fa-search"></i>
              </button>
            </div> 
            <div id="Coordinator" style="display: none;">
              <input name="Coordinator" type="text" placeholder="Enter Coordinator" class="input-field">
              <button type="submit" class="form-button" ></span><i class="fa fa-search"></i>
              </button>
            </div> 
      ...
      <table class="table table-bordered">
       <thead>
        ...
        <?php if($_SESSION['login_flag'] == 2 && isset($_SESSION['CH'])){  ?>
          ...
          <th>
            <form action="session_m.php" method="post">
            <input type="hidden" name="column" value="Purpose">
            <input type="hidden" name="order" value="<?php echo $asc_or_desc?>">
            <input type="hidden" name="flag" value="<?php echo $flag ?>">
            <a href="session_m.php" onclick="this.closest('form').submit();return false;">Purpose<i class="fas fa-sort<?php echo $column == 'Purpose' ? '-' . $up_or_down : ''; ?>"></i></a>
          </form>
          </th>
          <th>
            <form action="session_m.php" method="post">
            <input type="hidden" name="column" value="Students">
            <input type="hidden" name="order" value="<?php echo $asc_or_desc?>">
            <input type="hidden" name="flag" value="<?php echo $flag ?>">
            <a href="session_m.php" onclick="this.closest('form').submit();return false;">Students<i class="fas fa-sort<?php echo $column == 'Students' ? '-' . $up_or_down : ''; ?>"></i></a>
          </form>
        </th>
          <th>
            <form action="session_m.php" method="post">

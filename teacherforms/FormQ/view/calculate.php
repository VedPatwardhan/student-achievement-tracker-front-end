...
$print = isset($_SESSION['print']) ? $_SESSION ['print'] : 'FormQ:- All Teachers';
$sql_search = '';
$sql_dept = '';
$_SESSION['flag'] = $flag;  
  if($flag == 1){
...
<html lang="en">
  <head>
    <title>Form Q Information</title>
  <meta charset="utf-8">
        ...
        <div class="collapse navbar-collapse" id="navbarTogglerDemo03">
          ...
          <input list="search" name="search" id="srch" onchange="myFunction(this)" class="input-field center" autocomplete="off" placeholder="Search By">
            ...
            <div id="Participants" style="display: none;">
              <input name="Participants" type="text" placeholder="Enter Participants" class="input-field">
              <button type="submit" class="form-button" ></span><i class="fa fa-search"></i>
              </button>
            </div>
            ...
            <div id="Participant_name" style="display: none;">
              <input name="Participant_name" type="text" placeholder="Enter Participant_name" class="input-field">
              <button type="submit" class="form-button" ></span><i class="fa fa-search"></i>
              </button>
            </div> 
            <div id="Prize" style="display: none;">
              <input name="Prize" type="text" placeholder="Enter Prize" class="input-field"><br>
              <button type="submit" class="form-button" ></span><i class="fa fa-search"></i>
              </button>
            </div> 
            <div id="Level" style="display: none;">
              <input name="Level" type="text" placeholder="Enter Level" class="input-field"><br>
              <button type="submit" class="form-button" ></span><i class="fa fa-search"></i>
              </button>
            </div>
            <div id="Filename" style="display: none;">
              <input name="Filename" type="text" placeholder="Enter Filename" class="input-field"><br>
              <button type="submit" class="form-button" ></span><i class="fa fa-search"></i>
              </button>
            </div> 
            <li class="nav-item" >
...
<script type="text/javascript">
  function myFunction(option){
          ...
          if(opt == "Participant_name"){
            document.getElementById("Participant_name").style.display = "block";
            document.getElementById("srch").style.display = "none";
          }
          if(opt == "Prize"){
      ...
      <table class="table table-bordered">
       <thead>
        ...
        <?php if($_SESSION['login_flag'] == 2 && isset($_SESSION['CH'])){  ?>
          ...
          <th>
            <form action="session_m.php" method="post">
            <input type="hidden" name="column" value="Participant_name">
            <input type="hidden" name="order" value="<?php echo $asc_or_desc?>">
            <input type="hidden" name="flag" value="<?php echo $flag ?>">
            <a href="session_m.php" onclick="this.closest('form').submit();return false;">Participant name<i class="fas fa-sort<?php echo $column == 'Participant_name' ? '-' . $up_or_down : ''; ?>"></i></a>
            </form>
          </th>
          <th>
            <form action="session_m.php" method="post">
            <input type="hidden" name="column" value="Prize">
            <input type="hidden" name="order" value="<?php echo $asc_or_desc?>">
            <input type="hidden" name="flag" value="<?php echo $flag ?>">
            <a href="session_m.php" onclick="this.closest('form').submit();return false;">Prize<i class="fas fa-sort<?php echo $column == 'Prize' ? '-' . $up_or_down : ''; ?>"></i></a>
            </form>
          </th>
          <th>
            <form action="session_m.php" method="post">

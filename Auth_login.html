...
<html>
<head>
	<title>Auhtority Login Page</title>
	<link rel="stylesheet" type="text/css" href="stylehome1.css" >
 ...
 <li><a href="#">About us</a></li>
		...
		<div class="form-box" >
			<div class="button-box" >
				...
				<button type="submit" class="toggle-btn" onclick="register()"
			    >Register </button>
			  ...
			  <form id="login " class="input-group" action="server_log_auth.php" method="post">

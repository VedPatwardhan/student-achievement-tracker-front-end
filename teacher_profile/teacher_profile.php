...
<section id="blog">
      ...
      <div class="col-md-12 col-sm-12">
       <div class="about-info">
        <div class="section-title">
         <h3><b><b>A. Conferences, Seminars, Symposia, Workshops, FDP, STTP Organized /conducted</b></b></h3>
 ...
 <div class="row mt-5 pt-5">
  ...
  <div class="col-md-12 col-sm-12 ovrflow">
    <table class="table table-dark ovrflow">
      <thead>
        <tr>
...
<div class="container">
  ...
  <div class="row">
    <div class="col-md-12 col-sm-12">
     <div class="about-info">
      <div class="section-title">
       <h3><b>B. Webinar / video conference /Invited talks organized /conducted.</b></h3>
       <!-- <span class="line-bar">...</span> -->
     </div>
   </div>
 </div>
...
<div class="container">
  ...
  <div class="row">
    <div class="col-md-12 col-sm-12">
     <div class="about-info">
      <div class="section-title">
       <h3><b>C.  Teachers Attended Conferences, Seminars, Symposia, Workshops, FDP, STTP etc.</b></h3>
       <!-- <span class="line-bar">...</span> -->
     </div>
   </div>
 </div>
...
<div class="container">
  ...
  <div class="row">
    <div class="col-md-12 col-sm-12">
     <div class="about-info">
      <div class="section-title">
        <h3><b>D. Collaboration / MoU with National / International Institute/Industry /Research Center/Colleges/University.</b></h3>
        <!-- <span class="line-bar">...</span> -->
      </div>
    </div>
  </div>
...
<div class="container">
  ...
  <div class="row">
    <div class="col-md-12 col-sm-12">
     <div class="about-info">
      <div class="section-title">
       <h3><b>E. Center  of innovation / excellence</b></h3>
       <!-- <span class="line-bar">...</span> -->
     </div>
   </div>
 </div>
...
<div class="container">
  ...
  <div class="row">
    <div class="col-md-12 col-sm-12">
     <div class="about-info">
      <div class="section-title">
       <h3><b>F. Industry sponsored Labs.</b></h3>
       <!-- <span class="line-bar">...</span> -->
     </div>
   </div>
 </div>
...
<div class="container">
  ...
  <div class="row">
    <div class="col-md-12 col-sm-12">
     <div class="about-info">
      <div class="section-title">
       <h3><b>H. Financial support provided to students.</b></h3>
       <!-- <span class="line-bar">...</span> -->
     </div>
   </div>
 </div>
...
<div class="container">
  ...
  <div class="row">
    <div class="col-md-12 col-sm-12">
     <div class="about-info">
      <div class="section-title">
       <h3><b>I. Consultancy Projects</b></h3>
       <!-- <span class="line-bar">...</span> -->
     </div>
   </div>
 </div>
...
<div class="container">
  ...
  <div class="row">
    <div class="col-md-12 col-sm-12">
     <div class="about-info">
      <div class="section-title">
       <h3><b>K. Books / Book Chapter</b></h3>
       <!-- <span class="line-bar">...</span> -->
     </div>
   </div>
 </div>
...
<div class="container">
  ...
  <div class="row">
    <div class="col-md-12 col-sm-12">
     <div class="about-info">
      <div class="section-title">
       <h3><b>L. Research Publications in National and International Journals/Edited Books/Proceedings/Conference</b></h3>
       <!-- <span class="line-bar">...</span> -->
     </div>
   </div>
 </div>
...
<div class="container">
  ...
  <div class="row">
    <div class="col-md-12 col-sm-12">
     <div class="about-info">
      <div class="section-title">
       <h3><b>M. Research Projects/Schemes Undertaken by Teachers</b></h3>
       <!-- <span class="line-bar">...</span> -->
     </div>
   </div>
 </div>
...
<div class="container">
  ...
  <div class="row">
    <div class="col-md-12 col-sm-12">
     <div class="about-info">
      <div class="section-title">
       <h3><b>O. Student Achievement</b></h3>
       <!-- <span class="line-bar">...</span> -->
     </div>
   </div>
 </div>
...
<div class="container">
  ...
  <div class="row">
    <div class="col-md-12 col-sm-12">
     <div class="about-info">
      <div class="section-title">
       <h3><b>P. Departmental Achievement</b></h3>
       <!-- <span class="line-bar">...</span> -->
     </div>
   </div>
 </div>
...
<div class="container">
  ...
  <div class="row">
    <div class="col-md-12 col-sm-12">
     <div class="about-info">
      <div class="section-title">
       <h3><b>Q. Technical Competitions / Tech Fest Organized / Participated</b></h3>
       <!-- <span class="line-bar">...</span> -->
     </div>
   </div>
 </div>
...
<div class="container">
  ...
  <div class="row">
    <div class="col-md-12 col-sm-12">
     <div class="about-info">
      <div class="section-title">
       <h3><b>R. Industrial Visits / Tours</b></h3>
       <!-- <span class="line-bar">...</span> -->
     </div>
   </div>
 </div>
...
<div class="container">
  ...
  <div class="row">
    <div class="col-md-12 col-sm-12">
     <div class="about-info">
      <div class="section-title">
       <h3><b>T. Any other information (As applicable )</b></h3>
       <!-- <span class="line-bar">...</span> -->
     </div>
   </div>
 </div>

...
if (isset ($_POST['Type'])  && isset($_POST['Description']) && isset($_POST['Venue']) && isset($_POST['Achievements'])  && isset($_POST['DOB']) ) {
  ...
  $uid = uniqid("SW-");
  $sql = 'INSERT INTO social_work(UID,ID,Nature_of_work,Description,Associated_org,Venue,Date_SW) VALUES(:uid,:id,:type,:descp,:achieve,:venue,:dob)';
    ...
    <div class="card-body">
      ...
      <form method="post">
        ...
        <div class="form-group">
         ...
         <div class="form-group">
          <label for="Achievements">Associated_org</label>

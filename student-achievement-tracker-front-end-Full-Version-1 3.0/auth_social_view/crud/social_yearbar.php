...
$query = "SELECT Class,count(*) as num1 FROM student s inner join social_work sp WHERE s.ID=sp.ID and Year='$year' group by Class";
 ...
 <html lang="en">
  <head>
    <title>Social Work Activities</title>
    <!-- Required meta tags -->
    <meta charset="utf-8">

...
$SELECT = "SELECT ID From stu_temp Where ID = ? Limit 1";
     ...
     $rnum = $stmt->num_rows;
     if ($rnum==0) {
      $sql = "INSERT INTO stu_temp (ID, Full_Name,Class,Rollno,Year,Department,DOB,Email,Mobile,Address,Password) VALUES ('$id', '$fname', '$cls', '$roll', '$year', '$depart','$date','$email','$mno','$address','$pass')";

...
$uid = $_GET['uid'];
$message = '';
$sql = 'SELECT * FROM social_work WHERE ID=:id';
...
if (isset ($_POST['Type'])  && isset($_POST['Description']) && isset($_POST['Venue']) && isset($_POST['Achievements'])  && isset($_POST['DOB'])) {
  ...
  $sql = 'UPDATE social_work SET Nature_of_work=:fname,Description=:lname,Venue=:cls,Associated_org=:achieve,Date_SW=:dob WHERE UID=:uid';
  $statement = $connection->prepare($sql);
    ...
    <div class="card-body">
      ...
      <form method="post">
        ...
        <div class="form-group">
          <label for="Type">Nature_of_work</label>
          <input value="<?= $person->Nature_of_work; ?>" type="text" name="Type" id="fname" class="form-control">
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
         ...
         <div class="form-group">
          <label for="Achievements">Associated Organisation</label>
          <input value="<?= $person->Associated_org; ?>" type="text" name="Achievements" id="depart" class="form-control">
        </div>
         <div class="form-group">
          <label for="DOB">Date of Occasion</label>
          <input value="<?= $person->Date_SW; ?>" type="date" name="DOB" id="dob" class="form-control">
        </div>
        <div class="form-group">

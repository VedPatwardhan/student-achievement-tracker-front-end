...
<body>
   ...
   <ul>
 <li><a href="/projects/auth_profile_edit/crud/view_auth_profile.php">View Profile</a>
 </li>
 <li><a href="#">Statistics</a>
  <ul>
   ...
   <li><a href="/projects/auth_sports_view/crud/index.php">Sports</a></li>
 ...
 <li><a href="/projects/authhome.php">Graph Analysis</a>
 </li>
...
<div class="container">
  <div class="card mt-5">
    <div class="card-header">
      <h2>Monthly Report navigation page</h2>
    </div>
    <div class="card-body">
     

    <div class="form-group">
     <button type="submit" class="btn btn-info" onclick="form1()">All monthly reports data </button>
</div>
    </div>
  </div>
</div>
...
<script >
      function form1(){
        window.location = "teacherforms/Report/formslink.php";
      }

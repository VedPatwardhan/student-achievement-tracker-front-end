...
$query = "SELECT Class,count(*) as num1 FROM student  WHERE Year='$year' group by Class";
// $query = "SELECT Class,count(*) as num1 FROM student s inner join sports sp WHERE s.ID=sp.ID and Year='$year' group by Class";
 ...
 <html lang="en">
  <head>
    <title>ALL Student Activities</title>
    <!-- Required meta tags -->
    <meta charset="utf-8">
 ...
 <script type="text/javascript" src="https://www.google.com/jsapi"></script>
    ...
    var options = {
      title: 'Class wise Student participation',
